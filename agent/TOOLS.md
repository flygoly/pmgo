...
- **Read / reports / canvas:** `pmgo_project_list`, `pmgo_task_list`, `pmgo_milestone_list`, `pmgo_risk_*`, `pmgo_decision_list`, `pmgo_people_list`, `pmgo_retrospective_list`, `pmgo_daily_report`, `pmgo_weekly_report`, `pmgo_canvas_*`, `pmgo_feishu_task_list`, `pmgo_notion_page_list`, ...
- **Writes (policy may require `confirmed: true` ...):** `pmgo_project_create`, `pmgo_task_*`, `pmgo_milestone_*`, `pmgo_risk_*`, `pmgo_decision_*`, `pmgo_people_*`, `pmgo_retrospective_*`, `pmgo_github_sync_tasks`, `pmgo_github_push_done`, `pmgo_linear_comment`, `pmgo_feishu_import_task`, `pmgo_notion_import_task`, `pmgo_jira_transition_issue`, ...
