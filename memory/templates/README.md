...
- `daily-report.*.md`: classic daily log (done / in progress / plan tomorrow / blockers / risks).
- `daily-standup.*.md`: standup-style daily task snapshot (same data, alternate headings).
