...
**Tool names** exposed by the server include: `pmgo_project_list`, `pmgo_project_create`, `pmgo_task_list`, `pmgo_task_create`, `pmgo_daily_report`, `pmgo_weekly_report`, `pmgo_github_issue_list`, `pmgo_github_issue_get`, `pmgo_github_issue_create`, `pmgo_github_issue_close`, `pmgo_github_import_task`.
