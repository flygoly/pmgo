...
**Tool names** exposed by the server include: `pmgo_project_list`, `pmgo_project_create`, `pmgo_task_list`, `pmgo_task_create`, `pmgo_task_update`, `pmgo_milestone_list`, `pmgo_milestone_create`, `pmgo_milestone_update`, `pmgo_risk_scan`, `pmgo_daily_report`, `pmgo_weekly_report`, `pmgo_github_issue_list`, `pmgo_github_issue_get`, `pmgo_github_issue_create`, `pmgo_github_issue_close`, `pmgo_github_import_task`, `pmgo_linear_issue_list`, `pmgo_linear_issue_get`, `pmgo_linear_import_task`, `pmgo_jira_issue_list`, `pmgo_jira_issue_get`, `pmgo_jira_import_task`.

Personal GTD walkthrough: [gtd-quickstart.md](./gtd-quickstart.md).
